...
class ModelLoadTriangle : public ModelCommand
{
    using Action = std::shared_ptr<AbstractObject> (SolutionLoader::*)(const std::string&);
public:
    ModelLoadTriangle() = delete;
    ModelLoadTriangle(std::shared_ptr<AbstractObject>& obj, const std::string& filename, bool isbin);
    ~ModelLoadTriangle() = default;
