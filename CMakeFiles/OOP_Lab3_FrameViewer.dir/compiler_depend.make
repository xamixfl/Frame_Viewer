...
OOP_Lab3_FrameViewer_autogen/timestamp: CMakeFiles/3.30.8/CMakeCCompiler.cmake \
  CMakeFiles/3.30.8/CMakeCXXCompiler.cmake \
  CMakeFiles/3.30.8/CMakeSystem.cmake \
  CMakeLists.txt \
  OOP_Lab3_FrameViewer_autogen/moc_predefs.h \
  src/bridge/AssimpModelImpl.cpp \
  src/bridge/AssimpModelImpl.h \
  src/bridge/CarcasCamera.cpp \
  src/bridge/CarcasCamera.h \
  src/bridge/LightImpl.cpp \
  src/bridge/LightImpl.h \
  src/bridge/VectorCompositeImpl.cpp \
  src/bridge/VectorCompositeImpl.h \
  src/builder/AssimpModelBuilder.cpp \
  src/builder/AssimpModelBuilder.h \
  src/builder/BaseBuilder.cpp \
  src/builder/BaseBuilder.h \
  src/builder/CarcasCameraBuilder.cpp \
  src/builder/CarcasCameraBuilder.h \
  src/builder/CarcasModelBuilder.cpp \
  src/builder/CarcasModelBuilder.h \
  src/builder/SceneBuilder.cpp \
  src/builder/SceneBuilder.h \
  src/command/CameraCommands.cpp \
  src/command/CameraCommands.h \
  src/command/HistoryCommands.cpp \
  src/command/HistoryCommands.h \
  src/command/ModelCommands.cpp \
  src/command/ModelCommands.h \
  src/command/SceneCommands.cpp \
  src/command/SceneCommands.h \
  src/command/SetMaterialCommand.cpp \
  src/command/SetMaterialCommand.h \
  src/command/TransformCommands.cpp \
  src/command/TransformCommands.h \
  src/composite/BaseObject.cpp \
  src/composite/BaseObject.h \
  src/composite/Camera.cpp \
  src/composite/Camera.h \
  src/composite/CompositeObject.cpp \
  src/composite/CompositeObject.h \
  src/composite/Light.cpp \
  src/composite/Light.h \
  src/composite/Model.cpp \
  src/composite/Model.h \
  src/composite/Scene.cpp \
  src/composite/Scene.h \
  src/data/MaterialPresets.cpp \
  src/data/MaterialPresets.h \
  src/data/Point.cpp \
  src/data/Point.h \
  src/director/AssimpDirector.cpp \
  src/director/AssimpDirector.h \
  src/director/CarcasCameraDirector.cpp \
  src/director/CarcasCameraDirector.h \
  src/director/CarcasModelDirector.cpp \
  src/director/CarcasModelDirector.h \
  src/director/SceneDirector.cpp \
  src/director/SceneDirector.h \
  src/facade/Facade.cpp \
  src/facade/Facade.h \
  src/factory/QtDrawer.cpp \
  src/factory/QtDrawer.h \
  src/factory/QtDrawerFactory.cpp \
  src/factory/QtDrawerFactory.h \
  src/main.cpp \
  ...
  src/reader/AssimpReader.cpp \
  src/reader/AssimpReader.h \
  src/reader/AutoReader.cpp \
  src/reader/AutoReader.h \
  src/reader/BinaryReader.cpp \
  src/reader/BinaryReader.h \
  ...
  src/visitor/MoveVisitor.h \
  src/visitor/RotateVisitor.cpp \
  src/visitor/RotateVisitor.h \
  src/visitor/ScaleVisitor.cpp \
  src/visitor/ScaleVisitor.h \
  src/visitor/SetMaterialVisitor.h \
  /usr/bin/cmake \
